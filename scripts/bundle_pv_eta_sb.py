"""Bundler for `agents/baseline_pv_eta_sb`.
...
DEFAULT_WRAPPER = REPO / "agents" / "baseline_pv_eta_sb"
DEFAULT_OUT = REPO / "submissions" / "baseline_pv_eta_sb.py"
...
def _smoke_import(bundle_path: Path) -> None:
    spec = importlib.util.spec_from_file_location(
        "_bundle_pv_eta_sb_smoke", bundle_path,
    )
...
def build(
    ...
    header = (
        f"# Bundled by scripts/bundle_pv_eta_sb.py — composite + jsr:\n"
