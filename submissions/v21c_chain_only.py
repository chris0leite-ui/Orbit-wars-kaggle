...
# === agent ===
"""v21c_chain_only — v20 dogpile + chain_bonus ONLY.

Single-axis ablation: v20 prerank, then add 0.30 * follow-on-ECV where
the follow-on is the best affordable next-capture from this target
within 15 turns. No sun pre-filter, no rotation, no MissionBook.
"""
        ...
        for tgt in _nearest_k(target_pool, src, NUM_TARGETS_PER_SOURCE):
            ...
            for ships in _enumerate_ship_counts_basic(src, tgt, model, omega, me, world):
                ...
                cheap += compound_bonus(
                    ...
                    anchor_xy=None, mission_book=None, wait_N=0,
            ...
            for w_ships, w_wait_N, w_angle, w_eta in _wait_then_fire_candidate(
                ...
                w_cheap += compound_bonus(
                    src, tgt, w_ships, w_eta, world, model, me,
                    anchor_xy=None, mission_book=None, wait_N=w_wait_N,
                    use_rotation=False, use_chain=True, use_carry=False,
                )
                if w_cheap > -10.0:
                    prerank.append(
