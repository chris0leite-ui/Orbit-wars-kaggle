...
# Prepended env stack: BASELINE_VALUE_HEAD=strategic + orbitfix knobs + strategic-head calibration.
# Source commit: 3a054c7 — unified favor (one leaf for 2P+4P, asymmetric Term A,
#   max-of-opps, capture-feasibility gate). PI learning-submit 2026-05-26 PM.
from __future__ import annotations
import os as _bu_os
_bu_os.environ.setdefault("BASELINE_JOINT_AGGR", "1")
_bu_os.environ.setdefault("BASELINE_JOINT_TOP_K", "5")
_bu_os.environ.setdefault("BASELINE_JOINT_MAX_PAIRS", "60")
_bu_os.environ.setdefault("BASELINE_REINFORCE_EMIT", "1")
_bu_os.environ.setdefault("BASELINE_REINFORCE_ANTICIPATE", "1")
_bu_os.environ.setdefault("BASELINE_NEUTRAL_BONUS", "2.0")
_bu_os.environ.setdefault("BASELINE_NEUTRAL_EARLY_EXTRA", "1.5")
_bu_os.environ.setdefault("BASELINE_NEUTRAL_EARLY_HORIZON", "50")
_bu_os.environ.setdefault("BASELINE_ORBITAL_SAFETY", "1")
_bu_os.environ.setdefault("BASELINE_VALUE_HEAD", "strategic")
_bu_os.environ.setdefault("BASELINE_HOLD_HORIZON", "20")
_bu_os.environ.setdefault("BASELINE_FORWARD_REACH_WEIGHT", "0.5")
_bu_os.environ.setdefault("BASELINE_FORWARD_REACH_HORIZON", "15")
_bu_os.environ.setdefault("BASELINE_FINISH_BONUS", "50")
_bu_os.environ.setdefault("BASELINE_FINISH_THRESHOLD", "200")
