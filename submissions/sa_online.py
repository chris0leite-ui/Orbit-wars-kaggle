# Bundled by scripts/bundle_agent.py from agents/sa_online + lib/{geometry,fleet,orbit,aim,combat,world_model,intent,kinematic_table,trajectory,mechanism,mission,scoring,missions/snipe,missions/reinforce,missions/recapture,missions/opening,missions/drain,missions/gang_up,missions/opp_archetypes,planner,lookahead,lookahead_planner,game/interpreter,fast_sim,sa_core,opp_model,v7_search,candidate_portfolios,value_heads,joint_solver/opening_planner}.
...
# from lib.sa_core import _get_step  # inlined by bundle_agent.py
# from lib.sa_core import build_solo_snap0 as _build_solo_snap0  # inlined by bundle_agent.py
_build_solo_snap0 = build_solo_snap0
# from lib.sa_core import load_agent as _load_agent  # inlined by bundle_agent.py
_load_agent = load_agent
# from lib.sa_core import record_initial_plan  # inlined by bundle_agent.py
# from lib.sa_core import simulated_anneal_online  # inlined by bundle_agent.py
...
# from lib.intent import Intent  # inlined by bundle_agent.py
# from lib.intent import realize  # inlined by bundle_agent.py
