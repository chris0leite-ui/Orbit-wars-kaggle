# Bundled by scripts/bundle_agent.py from agents/baseline (variant: baseline_ev_per_ship) + lib/{geometry,fleet,orbit,aim,combat,world_model,intent,kinematic_table,trajectory,mechanism,mission,scoring,missions/snipe,missions/reinforce,missions/recapture,missions/opening,missions/drain,missions/gang_up,missions/opp_archetypes,planner,lookahead,lookahead_planner,game/interpreter,fast_sim,opp_model,v7_search,candidate_portfolios,value_heads,joint_solver/opening_planner}.
# Single-file Kaggle submission for Orbit Wars.

from __future__ import annotations

import os as _evps_os
_evps_os.environ.setdefault("BASELINE_JOINT_AGGR", "1")
_evps_os.environ.setdefault("BASELINE_JOINT_TOP_K", "5")
_evps_os.environ.setdefault("BASELINE_JOINT_MAX_PAIRS", "60")
_evps_os.environ.setdefault("BASELINE_REINFORCE_EMIT", "1")
_evps_os.environ.setdefault("BASELINE_REINFORCE_ANTICIPATE", "1")
_evps_os.environ.setdefault("BASELINE_NEUTRAL_BONUS", "2.0")
_evps_os.environ.setdefault("BASELINE_NEUTRAL_EARLY_EXTRA", "1.5")
_evps_os.environ.setdefault("BASELINE_NEUTRAL_EARLY_HORIZON", "50")
_evps_os.environ.setdefault("BASELINE_ORBITAL_SAFETY", "1")
_evps_os.environ.setdefault("BASELINE_SORT_BY_EV_PER_SHIP", "1")
