# Bundled by scripts/bundle_agent.py from agents/v8_minimal + lib/{geometry,fleet,orbit,aim,combat,world_model,intent,trajectory,mechanism,mission,missions/snipe,missions/reinforce,missions/recapture,planner,lookahead_planner,fast_sim,opp_model,v7_search,candidate_portfolios}.
...
# from lib.lookahead_planner import evaluate_value  # inlined by bundle_agent.py
# from lib.v7_search import choose_simple_2p, _infer_num_seats  # inlined by bundle_agent.py
