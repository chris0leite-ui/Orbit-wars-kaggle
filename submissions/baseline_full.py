...
import os as _aggr_os
_aggr_os.environ.setdefault("BASELINE_JOINT_AGGR", "1")
_aggr_os.environ.setdefault("BASELINE_JOINT_TOP_K", "5")
_aggr_os.environ.setdefault("BASELINE_JOINT_MAX_PAIRS", "60")
_aggr_os.environ.setdefault("BASELINE_REINFORCE_EMIT", "1")
_aggr_os.environ.setdefault("BASELINE_REINFORCE_ANTICIPATE", "1")
_aggr_os.environ.setdefault("BASELINE_NEUTRAL_BONUS", "2.0")
_aggr_os.environ.setdefault("BASELINE_NEUTRAL_EARLY_EXTRA", "1.5")
_aggr_os.environ.setdefault("BASELINE_NEUTRAL_EARLY_HORIZON", "50")
_aggr_os.environ.setdefault("BASELINE_ORBITAL_SAFETY", "1")
_aggr_os.environ.setdefault("BASELINE_STAGNANT_DRAIN", "1")
_aggr_os.environ.setdefault("BASELINE_COMBAT_STACK", "1")
_aggr_os.environ.setdefault("BASELINE_SNIPER", "1")
...
# from lib.world_model import _comet_paths_by_id, comet_remaining_lifetime  # inlined by bundle_agent.py
