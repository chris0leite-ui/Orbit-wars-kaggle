# Bundled by scripts/bundle_agent.py from agents/v8_fastbrain + lib/{geometry,fleet,orbit,aim,combat,world_model,intent,trajectory,mechanism,mission,missions/snipe,missions/reinforce,missions/recapture,planner,lookahead_planner,fast_sim,opp_model,v7_search,candidate_portfolios}.
...
# from lib.v7_search import _infer_num_seats, score_candidate  # inlined by bundle_agent.py
