...
# Single-file Kaggle submission for Orbit Wars — peak orbitfix preamble + BASELINE_PV_ETA=1 + BASELINE_LEAF_PV_2P=1.
...
# NEW (2026-05-28 PM): re-enable the 2P leaf production-PV term to fix the
# silent-turns pathology (knowledge-base/thoughts/2026-05-28-silent-turns-
# pre-existing-weakness.md). Activates the `_COMPOSITE_PV_ENABLED` block
# in the inlined `lib/value_heads.py` below.
_orbitfix_os.environ.setdefault("BASELINE_LEAF_PV_2P", "1")
...
# 2026-05-28 PM: also flipped on by the namespaced alias `BASELINE_LEAF_PV_2P=1`.
import os as _os
