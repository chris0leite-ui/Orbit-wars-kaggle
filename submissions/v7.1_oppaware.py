# Bundled by scripts/bundle_agent.py from agents/v7.1_oppaware + lib/{geometry,fleet,orbit,aim,combat,world_model,intent,trajectory,mechanism,mission,missions/snipe,missions/reinforce,planner,lookahead}.
...
# from lib.lookahead import env_from_obs, score_joint_action_symmetric  # inlined by bundle_agent.py
