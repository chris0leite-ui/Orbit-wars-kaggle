"""roi_dominance_200 — dominance gate, alpha = 2.00.
...
ALPHA = 2.00 — overwhelming-force threshold; only fire when the launch
clearly outguns the projected target garrison.
"""
