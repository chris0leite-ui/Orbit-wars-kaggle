"""nearest — control strategy: target the closest non-owned planet.

HYPOTHESIS: distance-greedy is the right targeting axis (this is the
control; it reproduces v1's targeting rule standalone, sharing the
DEFAULT_MECHANISMS stack so any divergence vs v1 is a mechanism-stack
effect, not a strategy effect).
"""
