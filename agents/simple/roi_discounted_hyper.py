"""roi_discounted_hyper — hyperbolic ETA discount on top of roi_arrival.

V2 (hyperbolic) in the strategy A/B test. Score multiplies production by
1 / (1 + LAMBDA * eta). LAMBDA = 0.05 chosen so a 10-turn flight retains
~67%, 20-turn ~50%, 40-turn ~33%. Hyperbolic decays slower than
geometric on long horizons — closer to "uncertainty grows linearly with
time" than "uncertainty compounds."
"""
