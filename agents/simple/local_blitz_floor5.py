"""local_blitz_floor5 — local_blitz with GARRISON_FLOOR = 5.

Holds back 5 ships at every source on every launch. Tests whether reserving
a token defender garrison saves enough planets to flip outcomes.
