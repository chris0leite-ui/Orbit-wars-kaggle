...
## 2026-05-15 (claude/competitive-programmer-setup-LHyoP)
...
- `tag: pi-hypothesis-unaudited-pre-architecture` — PI proposed
  ...
  **Fix:** PROMOTED to `improvements.md` — require live-game audit
  before architecting around a PI behavior-hypothesis.
...
- `tag: build-large-architecture-without-probe-of-value-gradient` —
  ...
  >50 LOC architectural additions. Held pending more evidence.
...
- `tag: value-head-magnitude-uncalibrated` — wired `cluster_value` at
  ...
  before any new value-head A/B. Held pending more evidence.
...
- `tag: chooser-leaf-noise-resists-additive-candidates` — 3 strict-
  ...
  candidate. Structurally absorbed.
