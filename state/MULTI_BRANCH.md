...
|---|---|---|---:|---|---|
| 2026-05-30 08:20 | game-theory-winning-strategy-SEU7P | baseline_redeploy_gangup — forward-redeploy + gang-up-support proposer generators + hybrid_spatial value head; on top of PV_ETA wrapper | ~1100-1200 (n=4 = 3/4 = 75% vs frozen anchor μ=1163.5, Wilson [0.30, 0.95] — wildly underdetermined; submit IS the live-ladder calibration) | 53131296 (baseline_validated, μ=1100.8) | ✅ PI explicit "submit to kaggle so I can observe" |
