...
|---|---|---|---|
| `claude/game-theory-winning-strategy-SEU7P` | Doctrine + empirical study + eval-protocol + between-band + chooser implementation spec all documented; no code yet | (a) `knowledge-base/concepts/reach-frontier-doctrine.md`; (b) `audit/2026-05-27-hold-time-empirical.md` (n=92 games, share-of-integral separation 0.488 wins vs losses, STRONG); (c) `knowledge-base/concepts/evaluation-metrics.md` (Rule 48 metric defaults); (d) `audit/2026-05-27-between-band-stratification.md` (μ 1200-1400 opponents share 0.46 vs μ 1000-1200 share 0.26 — chooser justified through μ ≈ 1400); (e) `knowledge-base/concepts/reach-frontier-chooser-design.md` (v1 implementation spec — 2P-first, ~400 LOC across 5 modules in `agents/reach_frontier/`, 6-step build sequence with hard exit conditions, ~3 h work) | PI review of the chooser design before any code lands. After review either: (A) greenlight implementation following the 6-step build sequence; or (B) iterate on the design (open questions in §12); or (C) close the μ ≥ 1500 sample gap first to set ceiling expectations. |
