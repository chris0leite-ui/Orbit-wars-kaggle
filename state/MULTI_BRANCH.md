...
|---|---|---|---|
| `claude/game-theory-winning-strategy-SEU7P` | Doctrine + empirical study + eval-protocol + between-band stratification all documented | (a) `knowledge-base/concepts/reach-frontier-doctrine.md`; (b) `audit/2026-05-27-hold-time-empirical.md` (n=92 games, share-of-integral separation 0.488 wins vs losses, STRONG); (c) `knowledge-base/concepts/evaluation-metrics.md` (Rule 48 metric defaults); (d) `audit/2026-05-27-between-band-stratification.md` (opponents in μ 1200-1400 take median share 0.46 vs μ 1000-1200 opponents taking 0.26 — chooser build directionally justified through μ ≈ 1400) | Chooser build is justified by the within-band + 1200-1400-stratification signal. Two paths: (A) build the 2P-priority reach-frontier chooser now; or (B) first close the μ ≥ 1500 sample gap via manual sub-ID discovery from the Kaggle web UI (~30 min PI time) to set chooser-ceiling expectations. PI sign-off required for either. |
