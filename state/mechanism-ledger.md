...
| a2-4p-weakness-exploitation | agents/baseline/value.py (4P-only A2: ELIMINATION_BONUS=55, WEAK_ENEMY_THRESHOLD=110, WEAKEST_ENEMY_MULT_4P=1.5, ELIMINATION_GATE_RATIO=0.9) | unit (28): green; bench: p50=91 p95=261 max=347ms; smoke vs nearest: 32/32 Wlo=0.89 PASS; h2h vs v15 (2P-only harness) cannot be exercised (4P-only change) | local (NEEDS 4P GATE) | Derived from romantamrazov/orbit-star-wars-lb-max-1224 (peak LB μ=1224, +109μ above v15 ceiling). 4P: weighted-sum of opps with 1.5× on the WEAKEST opp; elim bonus +55 when weakest_strength ≤ 110 AND my_strength ≥ 0.9× theirs. Next gate: `scripts/ffa_panel.py` 4P FFA validation. |
