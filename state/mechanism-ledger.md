...
| a2-4p-weakness-exploitation | agents/baseline/value.py (4P-only A2: ELIMINATION_BONUS=55, WEAK_ENEMY_THRESHOLD=110, WEAKEST_ENEMY_MULT_4P=1.5, ELIMINATION_GATE_RATIO=0.9) | unit (28): green; bench: p50=91 p95=261 max=347ms; smoke vs nearest: 32/32 Wlo=0.89 PASS; 4P FFA n=16-seeds (64 games): 46/64 (71.9%) first-place vs v15 40/64 (62.5%) — DIRECTIONAL +9.4pp but CIs overlap; needs noise re-verify (wallclock-budget-A/B-noise) | local (NEEDS NOISE-VERIFY) | Derived from romantamrazov/orbit-star-wars-lb-max-1224 (peak LB μ=1224, +109μ above v15 ceiling). 4P: weighted-sum of opps with 1.5× on the WEAKEST opp; elim bonus +55 when weakest_strength ≤ 110 AND my_strength ≥ 0.9× theirs. Single-component v15-mod per `pattern-overlay-on-tuned-baseline-doesnt-lift` — exposed to the same falsification risk as v21/v22/v23 once pooled n≥128. |
| a2-2p-uniform-bias-rolled-back | WEAKEST_ENEMY_MULT_2P=1.25 uniform multiplier on the single opp | h2h vs v15 (n=64): 25 wins (39.1%, Wlo=0.281, Whi=0.513) INCONCLUSIVE | **falsified, reverted** | Uniform 1.25× bias on the only 2P opp makes the chooser over-aggressive against v15's well-tuned calibration. Falsifies "uniform aggression is the 2P analog of 4P weakness targeting." Per-WEAKEST (4P) is the semantic insight; uniform (2P) is not. Reverted same session. |
